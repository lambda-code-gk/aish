...
pub enum ClientRequest {
    ...
    ShellExecApproval {
        ...
        /// 協調 handoff が subprocess 実行の代わりに生成した synthetic result。
        #[serde(default, skip_serializing_if = "Option::is_none")]
        handoff_result: Option<crate::HumanHandoffResult>,
    },
...
pub struct RequestContext {
    ...
    /// 親 shell_exec を client-side collaborative execution policy へ委譲する。
