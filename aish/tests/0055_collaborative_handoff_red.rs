...
#[test]
#[ignore = "0055 phase2: human_shell_child_has_handoff_env_vars"]
fn human_shell_child_has_handoff_env_vars() {
    panic!("0055 phase2 not implemented");
}

#[test]
#[ignore = "0055 phase2: human_shell_ctrl_d_returns_control_to_parent"]
fn human_shell_ctrl_d_returns_control_to_parent() {
    panic!("0055 phase2 not implemented");
}

#[test]
#[ignore = "0055 phase2: human_shell_exit_returns_control_regardless_of_code"]
