...
| 0054 | [0054_safe-file-write-tools-spec.md](spec/0054_safe-file-write-tools-spec.md) | 設計確定（実装中・Phase 1–3 完了） | Safe File Write Tools（`write_file` / `apply_patch`、承認・journal・SHA-256） |
