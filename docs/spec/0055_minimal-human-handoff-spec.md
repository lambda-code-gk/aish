...
timeout 時に ai / aish / human shell / shell 内 foreground / background process が全て消えることの完全な E2E 自動証明は 0055 では扱わない。これは将来の **0057 PTY Process Cleanup Hardening** などへ分離する。
...
- **0057** PTY Process Cleanup Hardening
