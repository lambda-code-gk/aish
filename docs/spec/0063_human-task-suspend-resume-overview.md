...
| 0063-C | `ai human-task resume`、新segment、複数回中断、全segment Evidence順序保持 | 正式 spec [`0064_human-task-resume-spec.md`](0064_human-task-resume-spec.md)。Done/continuation は含めない。resume cwd 不在時は Suspended を維持 |
