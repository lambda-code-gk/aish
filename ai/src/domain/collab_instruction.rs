...
mod tests {
    ...
    fn collaborative_instruction_forbids_unverified_completion_claims() {
        ...
        assert!(text.contains("suggested_commands"));
        assert!(text.contains("never auto-executed"));
