...
pub use collaborative_handoff::{
    ...
    mark_tool_completed, mark_uncertain_tools_on_disconnect, normalize_child_goal_meta,
    record_tool_running, should_close_child_goal, sync_tool_executions_from_executed,
    try_transition, upsert_tool_execution, validate_handoff_id, validate_shell_token,
    verify_handoff_token, CancelHandoffError, ChildGoalAchievement, ChildGoalCloseReason,
    ChildGoalCloseState, ChildGoalMeta, CollaborativeAgentRole, CollaborativeAuditKind,
    CollaborativeChildWorkMode, CollaborativePolicy, CommandCandidate, CommandCandidateSource,
    Handoff, HandoffCheckpoint, HandoffEvent, HandoffLease, HandoffShellSession, HandoffState,
